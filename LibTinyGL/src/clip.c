...
static _ikk_inline_ void interpolate(GLVertex *q,GLVertex *p0,GLVertex *p1,float t)
{
...
/* Line Clipping algorithm from 'Computer Graphics', Principles and
   Practice */
static _ikk_inline_ int ClipLine1(float denom,float num,float *tmin,float *tmax)
{
  float t;
...
static _ikk_inline_ void updateTmp(GLContext *c,
